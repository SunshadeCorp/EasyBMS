...
std::vector<std::pair<float, float>> SOC::soc_data_points;

void SOC::initialize_soc_data_points() {
    soc_data_points = std::vector<std::pair<float, float>>();
...
float SOC::voltage_to_soc(float cell_voltage) {
